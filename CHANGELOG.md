...
## [2026-08-10] — حساب موحّد · ولي أمر · خصوصية أدمن المنطقة

### ✨ ميزات
- أزرار ظاهرة لكل الأدوار: **الملف الشخصي** + **تسجيل الخروج** (`AccountMenu`)
- صفحات بروفايل + رفع صورة (`avatar_url` / `POST /auth/avatar`)
- بوابة ولي الأمر: بلا سايدبار، أيقونات 7 أعمدة، 4 مربعات رئيسية، `GET /parent/children/{id}/insights`
- دمج دوري/تحديات؛ تسمية **المعلم المناوب 24/7**

### 🔒 خصوصية
- أدمن المنطقة: للطالب الاسم + المواد فقط — بدون هاتف/إيميل/عنوان
- إنشاء الطلاب عبر `/register` فقط (ليس من لوحة الأدمن)
- المالية لأدمن المنطقة بدون أرقام هواتف الطلاب؛ التفاصيل الكاملة للسوبر أدمن

### 📄 توثيق
- `docs/PLATFORM_STATUS_2026-08-10.md`
- `docs/README.md` · `PROJECT_LOG.md` · `CHANGELOG.md`

### 🚀 نشر
- Commits: `cbb2817` · `44fc441` · `94239bd` · `206ee4b` · `447281e` على https://alyaqoutgroup.net
