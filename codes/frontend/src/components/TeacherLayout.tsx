...
const navItems = [
  ...
  { to: '/teacher/profile',      label: 'الملف الشخصي',  d: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <NotificationBell />
            <AccountMenu profilePath="/teacher/profile" roleLabel="معلم" />
          </div>
        </header>
