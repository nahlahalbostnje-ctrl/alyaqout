...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    api.get('/settings/public')
      ...
      .catch(() => { /* silently skip if not authenticated */ });
  }, []);
  ...
  return (
    <a
      ...
      style={{ bottom: hasBottomNav ? 90 : 24 }}
      className="fixed left-6 z-50 w-14 h-14 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all hover:scale-110 active:scale-95"
    >
