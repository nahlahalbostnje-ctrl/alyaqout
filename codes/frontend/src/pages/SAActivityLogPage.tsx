...
function screenLabel(targetType: string | null): string {
  ...
  const map: Record<string, string> = {
    ...
    Exam: 'الامتحانات',
    Homework: 'الواجبات',
    HomeworkSubmission: 'تسليم الواجبات',
    ExamSubmission: 'تسليم الامتحانات',
    ExamQuestion: 'أسئلة الامتحان',
    Course: 'المقررات',
    Lesson: 'الدروس',
    Unit: 'الوحدات',
    Video: 'الفيديوهات',
    ...
    SubscriptionInstallment: 'أقساط الاشتراك',
    Coupon: 'الكوبونات',
    Grade: 'الصفوف',
    Category: 'التصنيفات',
    LiveClass: 'الحصص المباشرة',
    ...
    League: 'الدوريات',
    LeagueParticipant: 'مشاركو الدوري',
    EncouragementMessage: 'رسائل التشجيع',
    GamificationPoint: 'نقاط التحفيز',
    PersonalItem: 'العناصر الشخصية',
    EmergencyRequest: 'طلبات الطوارئ',
    SocialLink: 'روابط التواصل',
    RolePermission: 'صلاحيات الأدوار',
    SupervisorStudent: 'ربط مشرف-طالب',
    NotificationBroadcast: 'بث الإشعارات',
  };
