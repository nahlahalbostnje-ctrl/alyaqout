...
export default function ParentLeaguePage() {
  ...
  return (
    <ParentLayout>
      <div dir="rtl" style={{ fontFamily: "'Cairo', sans-serif", padding: 24, maxWidth: 720 }}>
        <h1 style={{ margin: '0 0 6px', fontSize: 22, fontWeight: 900, color: '#1B2038' }}>الدوري والتحديات</h1>
        <p style={{ margin: '0 0 12px', color: '#6B7280', fontSize: 13 }}>ترتيب أبنائك بالنقاط + أفضل 10 في الدولة</p>
        <ParentActivityTabs active="league" />
        {loading ? <p>جاري...</p> : (
          <>
