...
const REPORT_SECTIONS = [
  ...
  {
    id:'teachers', icon:'👨‍🏫', title:'تقرير المعلمين', desc:'تقييم أداء المعلمين، نسب التفاعل، وجودة المحتوى المقدم',
    stats:[{l:'المعلمون النشطون',v:'898'},{l:'متوسط التقييم',v:'4.7'},{l:'الدورات المنشورة',v:'1,840'},{l:'إجمالي الطلاب',v:'12,842'}],
    color:C.teal,
  },
  {
