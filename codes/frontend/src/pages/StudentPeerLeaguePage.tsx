      ...
      <div style={{ padding:24, fontFamily:"'Cairo',sans-serif", direction:'rtl' }}>
        <div style={{ marginBottom:24 }}>
          <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:4 }}>
            ...
            <h1 style={{ color:'#1B2038', fontWeight:900, fontSize:22, margin:0 }}>دوري الزملاء</h1>
          </div>
          <p style={{ color:'#6B7280', fontSize:13, margin:0 }}>تحدّى زملاءك في مسابقات 1v1 واكسب نقاط XP</p>
        </div>
