      ...
      <div dir="rtl" style={{ padding:24, fontFamily:"'Cairo',sans-serif", minHeight:'100%' }}>
        <div style={{ marginBottom:24 }}>
          <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:4 }}>
            ...
            <h1 style={{ color:'#1B2038', fontWeight:900, fontSize:22, margin:0 }}>الإنجازات والشارات</h1>
          </div>
          <p style={{ color:'#6B7280', fontSize:13, margin:0 }}>معرض الأوسمة والشارات التقديرية لأبنائك</p>
        </div>
