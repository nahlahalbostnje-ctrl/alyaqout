...
### [2026-07-13] — OTP اختبار برقم واحد + تطبيع فلسطين 970/972

- **ما تم:**
  - `WASENDER_TEST_RECIPIENT`: كل رسائل OTP تُعاد توجيهها لرقم واتساب واحد (للاختبار فقط)
  - تطبيع أرقام فلسطين المحلية `05…` → `00970…` مع الإبقاء على فحص/إرسال 970 ثم 972
  - `PHONE_DEFAULT_COUNTRY=PS` جاهز لتوسيع الدول لاحقاً
- **الملفات:** `PhoneNormalizer.php`, `WaSenderService.php`, `AuthController.php`, `config/services.php`, `DEPLOYMENT.md`
